import { Component } from '@angular/core';
    ...
    import { PedidoDetalleService } from '../services/pedido_detalle.service';

    @Component({
      selector: 'app-pedido_detalle-page',
      standalone: true,
      ...
      template: `
        <mat-card class="page-card">
          ...
          <form [formGroup]="form" (ngSubmit)="save()" class="form-grid">
            <mat-form-field appearance=\"outline\"><mat-label>pedidoId</mat-label><input matInput type=\"number\" formControlName=\"pedidoId\" /></mat-form-field>
  ...
  <td mat-cell *matCellDef="let row">
    ...
    export class PedidoDetallePage {
      items: any[] = [];
      displayedColumns = ['id', 'pedidoId', 'productoId', 'cantidad', 'precioUnitario', 'subtotal', 'acciones'];
      ...
      constructor(private fb: FormBuilder, private service: PedidoDetalleService) {
        this.load();
      }
